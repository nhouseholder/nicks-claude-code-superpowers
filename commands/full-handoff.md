...
**CRITICAL RULE: The handoff header MUST match the directory you're in. If you're in `~/Projects/sports/ufc-predict/`, the handoff says "UFC Predict", NOT whatever project you were discussing in chat. The handoff documents THIS REPO's state.**
...
## Local path: [full local path — e.g., ~/Projects/sports/ufc-predict/]
