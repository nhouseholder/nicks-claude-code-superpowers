...
21. **All 5 bet types in every summary** — EventSlideshow, LastWeekPicks, EventBetsDropdown, and any component showing event summaries MUST include ML, Method, Round, Combo, AND Parlay. Missing any bet type = wrong combined P/L.
