...
COMMUNICATION_BRIEF = """COMMUNICATION RULES — FRONT AND CENTER (non-negotiable, every session):
...
- No post-amble ("In summary", "To summarize", "Let me know if..."). Answer IS the summary.
