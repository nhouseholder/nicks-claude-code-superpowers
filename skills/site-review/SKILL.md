---
name: site-review
description: Multi-agent site review panel. Dispatches senior-dev, frontend, and backend agents in parallel to review the current project from a **functional perspective** — not just bugs, but architecture, UX, performance, and improvement opportunities.
---
