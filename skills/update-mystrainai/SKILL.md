---
name: update-mystrainai
description: Dedicated MyStrainAI website agent. This command carries ALL domain knowledge for mystrainai.com — cannabis strain recommendations, Cannalchemy backend, React/Vite frontend, Supabase, and learned errors.
---
