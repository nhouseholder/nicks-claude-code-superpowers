---
name: site-recover
description: Recover the last working version of a site after a destructive deploy, accidental overwrite, or data loss. This is the EMERGENCY command — use when production is broken and you need to get back to a known-good state.
---
