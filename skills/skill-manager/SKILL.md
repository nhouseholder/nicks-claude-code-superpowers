...
Not every message needs 70 skills paying attention. Most messages need 2-5.
...
brainstorming, content-research-writer, error-memory, finishing-a-development-branch, git-sorcery, intent-detection, pre-debug-check, proactive-qa, prompt-improver, receiving-code-review, search-first, site-update-protocol, smart-clarify, spec-interview, verification-before-completion, version-bump
