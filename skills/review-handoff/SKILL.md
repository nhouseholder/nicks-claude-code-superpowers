---
name: review-handoff
description: Read the most recent handoff for this project and orient yourself to pick up where the last session left off. This is the FIRST thing you do when starting a new session.
---
