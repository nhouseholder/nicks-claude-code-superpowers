---
name: update-nestwisehq
description: Dedicated NestWise HQ website agent. This command carries ALL domain knowledge for nestwisehq.com — Next.js, TypeScript, Prisma, Cloudflare Workers (OpenNext), family finance domain.
---
