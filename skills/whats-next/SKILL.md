---
name: whats-next
description: Expert strategic advisor scoped to the CURRENT PROJECT ONLY. Reviews this project's handoff, memory, anti-patterns, git state, and codebase — then produces expert-level recommendations for what to do next.
---
