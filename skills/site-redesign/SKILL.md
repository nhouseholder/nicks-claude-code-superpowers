---
name: site-redesign
description: Redesign a website/webapp with production-grade quality using an agent pipeline architecture. Each phase dispatches a specialized agent. Agents communicate through shared memory files in `_redesign/`. Context is handed off explicitly between phases.
---
