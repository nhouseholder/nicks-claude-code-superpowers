---
name: update-researcharia
description: Dedicated Research Aria website agent. This command carries ALL domain knowledge for researcharia.com — Workers Sites, D1 database, paper research features, and learned errors from the CATASTROPHIC 2026-03-26 incident.
---
...
2. **New bug found?** → Append to `~/.claude/anti-patterns.md` with project prefix (e.g., "### [RESEARCHARIA] Workers Sites KV purge")
